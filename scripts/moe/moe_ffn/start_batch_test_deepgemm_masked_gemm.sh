...
export TORCH_CUDA_PROFILER_DIR_PATH="/root/torch_cuda_profiler/deepgemm_masked_gemm/"

export ITERATE_MAX_NUM_LOCAL_EXPERTS=192
export ITERATE_MAX_EXPECTED_M=512

nohup python -u kernel_perf_test/tests/moe/moe_ffn/batch_test_deepgemm_masked_gemm.py > batch_test_deepgemm_masked_gemm.log 2>&1 &
